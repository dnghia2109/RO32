...
@Service
public class IEmployeeServiceImplement implements IEmployeeService {
    ...
    public List<Employee> findEmployeeByAgeBetween(int age1, int age2) {
        return employeeRepository.findEmployeeByAgeBetween1(age1, age2);
    }

    @Override
    public List<Employee> getEmployeeSortByAge() {
